package com.yangjiang.controller.checkrukuid;
...
@Controller
@RequestMapping("/CheckrukuidController")
public class CheckrukuidController extends BaseController {
	private static final Logger logger = Logger.getLogger(CheckrukuidController.class);
	@Autowired
