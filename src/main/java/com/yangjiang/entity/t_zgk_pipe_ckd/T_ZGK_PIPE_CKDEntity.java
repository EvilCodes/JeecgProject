package com.yangjiang.entity.t_zgk_pipe_ckd;
 ...
 */
@Entity
@Table(name = "T_ZGK_PIPE_CKD", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class T_ZGK_PIPE_CKDEntity implements java.io.Serializable {
	/**出库单号*/
	...
	@Column(name ="status",nullable=false,precision=20,length=20)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  发运计划单明细号
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  发运计划单明细号
	 */
