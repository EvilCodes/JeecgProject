...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println("hexStringToBytes:"+hexStringToBytes.length);
		for (int j = 0; j < hexStringToBytes.length; j++) {
			System.out.print(hexStringToBytes[j]);
...
//			String result = PasswordUtil.decrypt("ea3d519525358e00", "admin", salt);
