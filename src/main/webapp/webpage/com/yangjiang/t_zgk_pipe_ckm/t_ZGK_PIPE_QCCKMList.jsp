...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="t_ZGK_PIPE_CKMList" title="汽车发运数据查询审核"  queryMode="group"
			actionUrl="QCTransportDataController.do?PipeUpDataGrid" idField="chukudanid" fitColumns="true"  pageSize="50" >			   
		   ...
		   <t:dgCol title="读取标志" field="READ_FLAG"></t:dgCol>	
   		   ...
   		   <t:dgToolBar title="作废" icon="icon-search" url="" funname="doTrash"></t:dgToolBar>
...
function ExporterExcel() {  
	...
	function doCheck(){
		...
		//alert("chukudanid:"+row.chukudanid);
		var id = row.chukudanid+"";
		$.dialog.confirm("确定要通过审核吗？",function(){
			$.ajax({
				url:"t_ZGK_PIPE_CKMController.do?doCheck",
				data:{ids:id},
				dataType:"json", 
	...
	function doTrash(index){
		...
		$.dialog.confirm("确定要作废吗？",function(){
			$.ajax({
				url:"t_ZGK_PIPE_CKMController.do?doTrash",
				data:{ids:id},
				dataType:"json", 
				success:function(data){
					tip(data.msg);
