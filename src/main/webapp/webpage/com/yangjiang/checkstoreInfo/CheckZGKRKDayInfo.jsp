 ...
 <table cellpadding="0" cellspacing="1" class="formtable">
 	<tr>		
				...
				<div id="right">
					...
					<t:datagrid name="instoreDataList" title="铸管库入库信息查询" checkbox="true"
			actionUrl="CheckZGKRKInfoController.do?datagrid"
			idField="inStoreDay">
							
								<t:dgCol title="库名" field="store_name"  ></t:dgCol>
								<t:dgCol title="入库日期" field="inStoreDay" ></t:dgCol>
								...
								<t:dgCol title="日入库数" field="rknum" ></t:dgCol>
								<t:dgCol title="入库重量" field="rkwt" ></t:dgCol>
								<t:dgCol title="规格" field="SPEC_DESC"  sortable="false"></t:dgCol>
