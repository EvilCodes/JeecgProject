 ...
 <table cellpadding="0" cellspacing="1" class="formtable">
 	<tr>		
				...
				<td class="value"><input class="inputxt" id="tuikudanid"
					name="tuikudanid" ignore="ignore" datatype="*"> <span
				...
				<div id="right">
					...
					<t:datagrid name="instoreDataList" title="退库信息查询"
			actionUrl="CheckZGKTKInfoController.do?datagrid"
			idField="dn" >							
								<t:dgCol title="库名" field="store_name"  ></t:dgCol>
								<t:dgCol title="规格" field="dn" ></t:dgCol>
								<t:dgCol title="日期" field="riqi" ></t:dgCol>
								<t:dgCol title="退回单位" field="consignee" ></t:dgCol>
