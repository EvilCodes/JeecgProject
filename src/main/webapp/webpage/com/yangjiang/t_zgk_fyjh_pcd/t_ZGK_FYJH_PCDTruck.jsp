...
<body>
	...
	<div id="main">
		<div id="south">		
			<form action="" title="查询条件" id="checkform">
				<table title="查询条件">
					<td style="font-size: x-large;color: blue;">汽车发运计划单生成表</td>				
			...
			<div style="border: 0px solid; height: 350px;width:1400px;" align="left">
				<t:datagrid name="outstoreList" title="铸管汽车发运计划列表"
								checkbox="true"  actionUrl="CheckZgTransportPlanQCController.do?planDataGrid"  idField="发货通知单明细号"
								   pagination="true">																							
	...
	<div style="border: 1px solid red; height:350px;width:1400px;">
				<t:datagrid name="pcdlist" title="生成派车单列表"
								...
								<t:dgCol title="产品代码" field="itemCode"  extendParams="editor:'text'"></t:dgCol>								
								<t:dgCol title="产品名称" field="itemName" editor="editor:'combobox'"  dictionary="T_MYJK_ZGQYCYS"></t:dgCol>																
								<t:dgCol title="承运商代码" field="carryCompanyCode" extendParams="editor:'text'"></t:dgCol>
								<t:dgCol title="承运商名称" field="carryCompanyName" extendParams="editor:'text'"></t:dgCol>								
		...
		<td align="right"><label class="Validform_label"> 请选择承运商: </label></td>				
				<td class="value">
					<t:dictSelect field="dn" type="select"
						datatype="*" dictTable="T_MYJK_ZGQYCYS" dictField="CARRY_COMPANY_CODE"
						dictText="CARRY_COMPANY_NAME" id="cys"></t:dictSelect>
				</td>				
		</tr>
		</table>
		</div>
	...
	**/
	...
	function addPlan(){	
            ...
            row.itemCode = selectRowsData.产品代码;
         	...
         	row.carryCompanyCode=cysdm;
         	row.carryCompanyName=cys;
         	row.specialDesc=selectRowsData.特殊合同描述;
         	row.expFlag=selectRowsData.内外销标识;
         	row.carryNum="";
         	row.carryWt="";        	
         	row.carNo="";
         	row.driverName="";
            ...
            row.id=getUuid(); 
         	...
         	console.info(row);
         	 globalplannum=globalplannum+selectRowsData.未派支数;
            }
		...
		function addRow(index){  	
			...
			$('#pcdlist').datagrid('appendRow',{
				...
				trnMode:rows.运输方式名称,
				specialDesc:rows.特殊合同描述,
				expFlag:rows.内外销标识,
				carryCompanyCode:cysdm,
				carryCompanyName:cys
			});	
