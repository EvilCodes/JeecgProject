...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="t_ZGK_FYJH_PCDList" title="火车派车单" actionUrl="t_ZGK_FYJH_PCDController.do?datagrid" queryMode="group" idField="id" fit="true">
   ...
   <t:dgCol title="日期" field="edittime" formatter="yyyy-MM-dd hh:mm:ss" query="true"></t:dgCol>
   <t:dgCol title="操作" field="opt"></t:dgCol>
   <t:dgDelOpt title="删除" url="t_ZGK_FYJH_PCDController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="t_ZGK_FYJH_PCDController.do?addorupdate" funname="add"  width="100%" height="100%"></t:dgToolBar>
