...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="t_ZGK_PIPE_TKDList" title="退库子表" actionUrl="t_ZGK_PIPE_TKDController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="退库单号" field="tuikudanid"   width="120"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="t_ZGK_PIPE_TKDController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="t_ZGK_PIPE_TKDController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="t_ZGK_PIPE_TKDController.do?addorupdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="t_ZGK_PIPE_TKDController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>