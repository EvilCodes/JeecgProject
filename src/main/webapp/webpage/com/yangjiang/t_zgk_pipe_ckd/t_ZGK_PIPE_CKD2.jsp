...
<form action="" id="searchpipecodeForm">
 <table cellpadding="0" cellspacing="1" class="formtable">
 	<tr>		
				...
				<span></span>
				<td class="value"><input type="button" class="button" name="查询" onclick="checkorder()"
					value="查询生产计划" style="font-size: 22 ">
				</td>
				<td class="value">
				<input type="button" name="添加计划到列表" onclick="addPipecode()"
									value="添加计划到列表" style="font-size: 14,large; ">
				</td>
				<td class="value"><input type="button" class="button" name="提交入库信息" value="提交入库信息"
						onclick="save()"></td>
			</tr>
			<tr>
