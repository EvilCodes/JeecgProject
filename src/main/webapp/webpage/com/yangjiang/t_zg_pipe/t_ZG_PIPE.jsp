		...
		function save(){	
			...
			**/
			endEdit();
          	...
          	$.ajax({
				    url: "t_ZG_PIPEController.do?save",
...
<form action="" id="searchpipecodeForm">
 <table cellpadding="0" cellspacing="1" class="formtable">
 	<tr>		
				...
				<td colspan="5" align="center" style="font-size: 22"><span style="font-size: 22;color: sliver">铸管交库</span></td>
				<span></span>
				<td class="value"><input class="button" name="查询" onclick="checkorder()"
					value="查询生产计划" style="font-size: 22 ">
				</td>
				<td class="value">
				<input class="button" name="添加计划到列表" onclick="addPipecode()"
									value="添加计划到列表" style="font-size: 14,large; ">
				</td>
			...
			<tr>
				...
				<td align="right">
					...
					<td class="value">
						<t:dictSelect field="product_line" type="select" datatype="*"  dictTable="T_ZG_PACKAGE_LINE"
						dictField="line_name" dictText="line_name"  id="product_line" ></t:dictSelect>
				...
				<div id="right">
					<div style="border: 1px solid red; height: 200px;width:1400px;"
		align="left">
		<t:datagrid name="instoreDataList" title="计划列表" checkbox="true"
			actionUrl="myjkscjhController.do?orderDataGrid"
			idField="product_plan_no">			
...
<div id="top">
		<div style="border: 1px solid blue; height: 500px;width:1400px;"
		align="left">
		<t:datagrid name="instoreDetailList" title="入库数据" checkbox="true"
			...
			<t:dgCol title="批次" field="batch"  extendParams="editor:'text'"></t:dgCol>
			<t:dgCol title="管号" field="pipeserial"   extendParams="editor:'text'"></t:dgCol>						
