...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="t_ZG_PIPEList" title="入库管材" checkbox="true"
	 actionUrl="t_ZGK_PIPE_RKMController.do?datagrid4&rukudanid=${rukudanid }"  idField="pipe_code"  autoLoadData="true"
								  pagination="true"  >									  							 
	   ...
	   <t:dgCol title="层内序号" field="cengneixuhao"  ></t:dgCol>		
	    <t:dgToolBar title="删除"  icon="icon-remove" url="t_ZGK_PIPE_RKDController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>														 																										
		</t:datagrid>
  </div>
 </div>
 <script>
