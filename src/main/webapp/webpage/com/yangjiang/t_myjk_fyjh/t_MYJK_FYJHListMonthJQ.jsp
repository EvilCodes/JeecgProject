...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="t_MYJK_FYJHList" title="胶圈发运计划明细查询" actionUrl="CheckFYJHJQController.do?CheckFYJHMonthDataGrid" 
  idField="id" fit="true" queryMode="group" checkbox="true">   
   ...
   <t:dgCol title="交货日期" field="交货日期"  formatter="yyyy-MM-dd hh:mm:ss"></t:dgCol>
   ...
   <t:dgCol title="等级序码" field="等级序码"></t:dgCol>
