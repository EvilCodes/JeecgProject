					...
					<div class="login-container">
						<div class="center">
							<h1 id="id-text2" class="grey">
								<i class="ace-icon fa fa-leaf green"></i> 广东新兴铸管生产管理系统111
							</h1>
										...
										<div class="widget-main">
											...
											<label class="block clearfix"> <span
												class="block input-icon input-icon-right"> <input
													...
													placeholder="请输入用户名" id="userName" value="guest" /> <i
												...
												class="block input-icon input-icon-right"> <input
													...
													class="ace-icon fa fa-lock"></i> </span> </label>

											<div class="space"></div>
											<div class="clearfix">
												<label class="inline"> <input type="checkbox"
													class="ace" id="on_off" name="remember" value="yes" /> <span
													class="lbl">记住用户名</span> </label>
											...
											<div style="float: right">
												<a href="#" class="forgot-password-link"> 语言 <i
													class="ace-icon fa fa-arrow-right"></i> <t:dictSelect
														...
														defaultVal="zh-cn"></t:dictSelect> </a>
											</div>
										</div>
									</form>
								</div>
